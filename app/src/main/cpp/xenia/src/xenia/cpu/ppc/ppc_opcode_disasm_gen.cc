...
PPCOpcodeDisasmInfo ppc_opcode_disasm_table[] = {
  ...
  // ps_* disasm table entries (Agent D) to keep size==kInvalid assert in sync with enum/table.
  // (real PrintDisasm_ps_* + generator run left to other agents; placeholder disasm ok for now)
  INSTRUCTION(0x1000002a, "ps_addx"     , kA      , kF, kGeneral, "Paired Single Add"                                                          , (PPCOpcodeField::kFA,PPCOpcodeField::kFB), (PPCOpcodeField::kFD,PPCOpcodeField::kCRcond,PPCOpcodeField::kFPSCR), PrintDisasm_faddx),
  INSTRUCTION(0x1000003a, "ps_maddx"    , kA      , kF, kGeneral, "Paired Single Multiply-Add"                                                 , (PPCOpcodeField::kFA,PPCOpcodeField::kFC,PPCOpcodeField::kFB), (PPCOpcodeField::kFD,PPCOpcodeField::kCRcond,PPCOpcodeField::kFPSCR), PrintDisasm_fmaddx),
  INSTRUCTION(0x10000038, "ps_msubx"    , kA      , kF, kGeneral, "Paired Single Multiply-Subtract"                                            , (PPCOpcodeField::kFA,PPCOpcodeField::kFC,PPCOpcodeField::kFB), (PPCOpcodeField::kFD,PPCOpcodeField::kCRcond,PPCOpcodeField::kFPSCR), PrintDisasm_fmsubx),
  INSTRUCTION(0x1000001a, "ps_mulx"     , kA      , kF, kGeneral, "Paired Single Multiply"                                                     , (PPCOpcodeField::kFA,PPCOpcodeField::kFC), (PPCOpcodeField::kFD,PPCOpcodeField::kCRcond,PPCOpcodeField::kFPSCR), PrintDisasm_fmulx),
  INSTRUCTION(0x1000004a, "ps_mrx"      , kA      , kF, kGeneral, "Paired Single Move"                                                         , (PPCOpcodeField::kFB), (PPCOpcodeField::kFD,PPCOpcodeField::kCRcond,PPCOpcodeField::kFPSCR), PrintDisasm_fmrx),
  INSTRUCTION(0x10000028, "ps_subx"     , kA      , kF, kGeneral, "Paired Single Subtract"                                                     , (PPCOpcodeField::kFA,PPCOpcodeField::kFB), (PPCOpcodeField::kFD,PPCOpcodeField::kCRcond,PPCOpcodeField::kFPSCR), PrintDisasm_fsubx),
  INSTRUCTION(0x10000017, "ps_sel"      , kA      , kF, kGeneral, "Paired Single Select"                                                       , (PPCOpcodeField::kFA,PPCOpcodeField::kFC,PPCOpcodeField::kFB), (PPCOpcodeField::kFD,PPCOpcodeField::kCRcond,PPCOpcodeField::kFPSCR), PrintDisasm_fselx),
